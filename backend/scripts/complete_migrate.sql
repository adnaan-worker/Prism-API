-- Complete Database Migration Script for Prism API
...
CREATE TABLE IF NOT EXISTS api_keys (
    ...
    rate_limit BIGINT NOT NULL DEFAULT 60,
...
CREATE TABLE IF NOT EXISTS api_configs (
    ...
    max_rps BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS pricings (
    ...
    CONSTRAINT idx_config_model UNIQUE (api_config_id, model_name)
);
...
CREATE INDEX IF NOT EXISTS idx_billing_transactions_request_log_id ON billing_transactions(request_log_id);
CREATE INDEX IF NOT EXISTS idx_billing_transactions_pricing_id ON billing_transactions(pricing_id);

-- 9. Request Caches table
